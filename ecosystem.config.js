    ...
    apps: [
      {
        ...
        env: {
          ...
          NEXT_PUBLIC_SURVEY_SERVICE_URL: 'http://survey.research-connectllc.com/api/survey',
          NEXT_PUBLIC_AUTH_API: 'http://survey.research-connectllc.com/api/auth'
        },
        env_production: {
          NODE_ENV: 'production',
          PORT: 3000,
      ...
      },
      {
        ...
        env: {
          ...
          CORS_ORIGIN: 'http://survey.research-connectllc.com',
          },
        env_production: {
          NODE_ENV: 'production',
          PORT: 3001,
      ...
      },
      {
        ...
        env: {
          ...
          PUBLIC_BASE_URL: 'http://survey.research-connectllc.com',
        ...
        env_production: {
          ...
          RATE_LIMIT_MAX_REQUESTS: '1000',
          CORS_ORIGIN: 'http://survey.research-connectllc.com',
          AUTH_SERVICE_URL: 'http://62.72.29.150:3001',
          ENABLE_METRICS: 'true',
          METRICS_PORT: '9090',
          LOG_LEVEL: 'info',
          EVENT_ENABLED: 'true',
