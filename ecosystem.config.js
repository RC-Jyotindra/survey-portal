    ...
    apps: [
      {
        ...
        env: {
          ...
          NEXT_PUBLIC_SURVEY_SERVICE_URL: 'http://72.61.237.84/api/survey',
          NEXT_PUBLIC_AUTH_API: 'http://72.61.237.84/api/auth'
        },
        env_production: {
          NODE_ENV: 'production',
          PORT: 3000,
      ...
      },
      {
        ...
        env: {
          ...
          PUBLIC_BASE_URL: 'http://72.61.237.84',
        ...
        env_production: {
          ...
          RATE_LIMIT_MAX_REQUESTS: '1000',
          CORS_ORIGIN: 'http://72.61.237.84',
          AUTH_SERVICE_URL: 'http://72.61.237.84:3001',
          ENABLE_METRICS: 'true',
          METRICS_PORT: '9090',
          LOG_LEVEL: 'info',
          EVENT_ENABLED: 'true',
